...
// Solution method: Dinic's Max FLow algorithm but not making use of the fact that there is a bound on the capacity

 import java.util.Scanner;
 import java.util.ArrayList;
 import java.util.Arrays;
 
public class kevin3slow {

	static final int MAXT = 100;
	static final int MAXL = 1000;
	static final int MAXS = 1000;
	static final int MAXN = (MAXT+1) * MAXL + 1;
  ...
  public static void main(String[] args) {
	...
	for (run = 0; run < runs; run++)
	{
			...
			//System.out.println( maxFlow(graph, start, l*(t+1)) );
			System.out.println( java.lang.Math.min(maxFlow(graph, start-1, l*(t+1)),p) );
	}
  }
}
