...
public class PerformanceReviewSegTree {
  ...
  static long query(int pos, int a, int b, int key) {
    ...
    if (a <= cur.from && b >= cur.to) {
      ...
      */
      return cur.sums.get(ind);  // not ind-1 because there's a dummy 0 in the begining of this vector 
    } else {
